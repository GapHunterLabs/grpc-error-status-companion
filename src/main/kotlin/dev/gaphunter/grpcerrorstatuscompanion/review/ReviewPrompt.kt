package dev.gaphunter.grpcerrorstatuscompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.grpcerrorstatuscompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.grpcerrorstatuscompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "gRPC Error Status Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33810-grpc-error-status-companion/reviews"
